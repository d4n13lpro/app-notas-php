...
<body class="h-full">
    <div class="min-h-full">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <a href="./" aria-current="page" class="rounded-md text-gray-300 px-3 py-2 text-sm font-medium">Home</a>
                                <a href="about" class="text-gray-300 bg-gray-950/50 rounded-md px-3 py-2 text-sm font-medium  hover:bg-white/5 text-white">About</a>
        ...
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <p class="text-gray-400">Now you are on the About page</p>
