...
<body class="h-full">
    <div class="min-h-full">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <a href="./" aria-current="page" class="rounded-md text-gray-300 px-3 py-2 text-sm font-medium hover:text-white">Home</a>
                                <a href="about" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">About</a>
                                <a href="contact" class="bg-gray-950/50 rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 text-white">Contact</a>
                            </div>
                        </div>
                    </div>
        ...
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <p class="text-gray-400">Hello. Welcome to the Contact page</p>
